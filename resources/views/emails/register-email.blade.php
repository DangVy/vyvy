<table style="width: 100%; border-spacing: 0px">
    ...
    <tr>
        <td colspan="2" style="border-bottom: 1px solid black;border-right: 1px solid black;border-left: 1px solid black; padding: 5px;"> Khách hàng vừa đăng ký tài khoản có thông tin như sau: </td>
    </tr>
    <tr>
