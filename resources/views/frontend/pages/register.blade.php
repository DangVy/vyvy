...
@section('title')
Đăng kí tài khoản vào Shop Hoa tươi - Sunshine
@endsection
            ...
            -->
                    <div class="alert alert-danger" ng-show="contactForm.$invalid">
                        <ul>
                            ...
                            <li><span class="error" ng-show="contactForm.message.$error.required">Vui lòng nhập tên tài khoản</span></li>
                            <li><span class="error" ng-show="contactForm.message.$error.minlength">tên phải > 6 ký tự</span></li>
                            <li><span class="error" ng-show="contactForm.message.$error.maxlength">Lời nhắn phải <= 250 ký tự</span> </li> </li> </div> <!-- Div Thông báo validate hợp lệ Chỉ hiển thị khi các validate trong form `contactForm` không hợp lệ=> contactForm.$valid = true
                                        ...
                                        <div class="alert alert-success" ng-show="contactForm.$valid">
                                            Thông tin hợp lệ, vui lòng bấm nút <b>" Đăng ký "</b> để gởi mail đến Quản trị trang web<br />
                                            Cảm ơn quý khách hàng đã đăng ký tài khoản  !!
                                        </div>
                                        <!-- Validate email -->
                                        ...
                                        <div class="bor8 m-b-30">
                                            <textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="message" placeholder="Tên tài khoản của bạn" ng-model="message" ng-minlength="6" ng-maxlength="250" ng-required=true></textarea>
                                        </div>
                                        <!-- Nút submit form -->
        ...
        $scope.submitContactForm = function() {
            ...
            if ($scope.contactForm.$valid) {
                ...
                $http({
                    ...
                    swal('Thành công rồi :))) !', 'Cảm ơn bạn đã đăng ký tài khoản vào công ty của chúng tôi!', 'success');
