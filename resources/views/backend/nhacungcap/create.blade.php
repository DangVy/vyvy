...
@section('content')
<form method="post" action="{{ route('backend.nhacungcap.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="ncc_email" name="ncc_email" value="{{ old('ncc_email') }}">
    </div>
    
    <div class="form-group">
        <label for="ncc_taoMoi">Ngày tạo mới</label>
        <input type="text" class="form-control" id="ncc_taoMoi" name="ncc_taoMoi" value="{{ old('ncc_taoMoi') }}" data-mask-datetime>
    </div>
    <div class="form-group">
        <label for="ncc_capNhat">Ngày cập nhật</label>
        <input type="text" class="form-control" id="ncc_capNhat" name="ncc_capNhat" value="{{ old('ncc_capNhat') }}" data-mask-datetime>
    </div>
